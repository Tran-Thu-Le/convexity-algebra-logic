...
**Định lý 3.1.2 (Key Lemma — Kết quả quan trọng nhất - tác giả chưa hiểu chứng minh này - đề nghị làm rõ thông qua bổ đề phân rã của bipolar).** Với $E,F\in\mathbb X$: $E+_{fib}^{(s)}F\in\mathbb X$, và do đó $E\oplus F=E+_{fib}^{(s)}F$.
